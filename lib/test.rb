...
require 'twitter'
Dotenv.load'../.env' # Ceci appelle le fichier .env grâce à la gem Dotenv, et importe toutes les données enregistrées dans un hash ENV
